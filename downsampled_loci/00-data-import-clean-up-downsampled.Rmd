...
fdf <- read.table("../extdata/downsampled_loci/downsampled_taxonomy-file-list.txt", stringsAsFactors = FALSE, header = TRUE) %>%
  tbl_df()
dir <- "../extdata/downsampled_loci/taxonomy"
...
# and save that
saveRDS(taxonomy_loc_collapsed, "../extdata/downsampled_loci/data/downsampled_taxonomy_df.rds", compress = "xz")
...
# get the names of the files
fdf <- read.table("../extdata/downsampled_loci/downsampled_feature-table-file-list.txt", stringsAsFactors = FALSE, header = TRUE) %>%
  tbl_df()
dir <- "../extdata/downsampled_loci/feature_tables"
...
saveRDS(complete_loc_feature_tbls, file = "../extdata/downsampled_loci/data/downsampled_features_df.rds", compress = "xz")
